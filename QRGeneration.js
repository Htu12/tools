...
class QRGeneration {
  ...
  #generateBillNumber() {
    return (
      QRGeneration.#CONSTANTS.BILL_PREFIX +
  ...
  #getMerchantInfo() {
    ...
    const merchantData = this.#buildTLV(
      QRGeneration.#CONSTANTS.MERCHANT_ID,
      this.accNo,
    );
  ...
  #getAdditionalData() {
    ...
    const billData = this.#buildTLV(
      QRGeneration.#CONSTANTS.BILL_NUMBER_ID,
      this.billNumber,
    );
    const purposeData = this.#buildTLV(
      QRGeneration.#CONSTANTS.PURPOSE_ID,
      this.desc,
    );

    return this.#buildTLV(
      QRGeneration.#CONSTANTS.ADDITIONAL_DATA_ID,
      billData + purposeData,
    );
  }
  ...
  generateQR() {
    const qrData =
      QRGeneration.#CONSTANTS.PAYLOAD_FORMAT +
